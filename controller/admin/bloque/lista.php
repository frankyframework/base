...
$title_grid =_("Bloques");
$class_grid = "cont_cms";
$error_grid = _("No hay bloques registrados");
$deleteFunction ="EliminarBloque";
$frm_constante_link = FRM_CMS_BLOQUE;
$titulo_columnas_grid = array("id" => _("ID"),"fecha" => _("Fecha"), "titulo" =>  _("Titulo"),'friendly' => _("ID Path"));
...
$permisos_grid = "administrar_template_de_bloque";
