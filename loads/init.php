...
foreach ($catalogo_idiomas as $idioma => $path_idioma)
{
      ...
      if($MyFrankyMonster->isAccount() || $MyFrankyMonster->isAccount())
      {
        $callbacks_idioma[$idioma] = $MyRequest->url($urlInternacional[$idioma][$MyFrankyMonster->MyId()],$MyRequest->getUrlParam(),true);
