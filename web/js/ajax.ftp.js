...
function simpleResponseFTPHTML(response)
{
    if (response != "null")
    {
        ...
        {
            window.open("/admin/media/descargar.php?file="+respuesta['dowload']);
        }
    }
}
    ...
    if (response != "null")
    {
        ...
        {   
            ...
            if(respuesta['ls_remoto'])
            {
                ...
                if($("#path_ftp").text() != "/" && $("#path_ftp").text() != "")
                {
                ...
                for(var i = 0; i < respuesta['ls_remoto'].length; i++)
                {
                    ...
                    {
                        $("#contenedor_archivos_remotos").append('<div class="contenedor_columnas w-xxxx-12 w-xxx-12 w-xx-12 w-x-12"><div class="w-xxxx-8 w-xxx-8 w-xx-8 w-x-8"><a href="#" class="ftp_'+(respuesta['ls_remoto'][i][1])+'">'+respuesta['ls_remoto'][i][0]+'</a></div>'+html_button_ftp+'</div>');
                ...
                for(var i = 0; i < respuesta['ls_remoto'].length; i++)
                {
                    if(respuesta['ls_remoto'][i][1] == 'file')
                    {
                        $("#contenedor_archivos_remotos").append('<div class="contenedor_columnas w-xxxx-12 w-xxx-12 w-xx-12 w-x-12"><div class="w-xxxx-8  w-xxx-8 w-xx-8 w-x-8"> <i class="icon icon-documento"></i><span class="ftp_'+(respuesta['ls_remoto'][i][1])+'">'+respuesta['ls_remoto'][i][0]+'</span></div>'+html_button_ftp+'</div>');
